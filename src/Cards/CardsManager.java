...
public class CardsManager {
    ...
    private ArrayList<Cards> createCardList() {
        ...
        cards.add(new Cards(-140, randomNumbers.get(16), new ImageIcon("monkeyDrawing.png"), "Your monkey draws all over the walls, clean the walls, pay for monkey training"));
        ...
        cards.add(new Cards(-200, randomNumbers.get(19), new ImageIcon("monkeyDrawing.png"), "Your monkey says attacks a zookeeper."));
        return cards;
    }
