...
public class CardsManager {
    ...
    private ArrayList<Cards> createCardList() {
        ...
        cards.add(new Cards(-20, randomNumbers.get(10), new ImageIcon(getClass().getResource(userDir +"dogEatingAllFood.png")), "Your dog escapes and steals food."));
        ...
        cards.add(new Cards(-100, randomNumbers.get(14), new ImageIcon(getClass().getResource(userDir +"dogEatingAllFood.png")), "Your dog steals kids lunch that costed a 'reasonable' price."));
